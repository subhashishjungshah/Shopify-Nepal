  ...
  return (
    <div className="popular__brand__container">
      ...
      <div className="image__container">
        ...
        />
        <img
          src="https://www.virginmegastore.qa/medias/Collin-Debdens-logo.webp?context=bWFzdGVyfHJvb3R8MzA4MnxhcHBsaWNhdGlvbi9vY3RldC1zdHJlYW18aGFhL2gwNC8xMDMwMDE0NTM2OTExOC9Db2xsaW4tRGViZGVucy1sb2dvLndlYnB8YjkwNzczOTc3ZjIzYjkyMDRlZWJhYzE3ZTAwMjUwZDc2YWI4M2ZkNTJiNjIyZTAzZjc0NzA0ODRhZGRjYzU3Ng"
          alt="images"
        />
        <img
          src="https://www.virginmegastore.qa/medias/Capslab-logo.webp?context=bWFzdGVyfHJvb3R8MzU0MnxhcHBsaWNhdGlvbi9vY3RldC1zdHJlYW18aGExL2g1OC8xMDI5OTczMDQ5MzQ3MC9DYXBzbGFiLWxvZ28ud2VicHw0NjYzYjg3Mjg0ZDQ4ODEzMGQ5NGE3YjhhNTRkOWMxNGMwODdlNWYzNTZkNzVkZjk2MjNkZjkzZDBkYjRlYTY5"
          alt="images"
        />
      </div>
    </div>
